...
export default class View {
   ...
   * @param {boolean} [render=true] If false create markup string,instead render the recipe
   * @returns {undefined | string} The markup string is returned if render=false
